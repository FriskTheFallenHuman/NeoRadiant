...
std::shared_ptr<ShaderTemplate> ShaderLibrary::getTemplate(const std::string& name)
{
	...
	if (auto img = GlobalImageLoader().imageFromVFS(name); img)
	{
        ...
        decl->setFileInfo(vfs::FileInfo("materials/", "_autogenerated_.mtr", vfs::Visibility::HIDDEN));
    ...
    decl->setDescription("This material is missing and has been auto-generated by NeoRadiant");

    // Make the definition VFS-visible to let them show in MediaBrowser (#5475)
    decl->setFileInfo(vfs::FileInfo("materials/", "_autogenerated_.mtr", vfs::Visibility::NORMAL));
