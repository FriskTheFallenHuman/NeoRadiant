...
const char* const TOPLEVEL_NODE_NAME = "neoradiant";

class RegistryTree
{
private:
	// The top level node name ("neoradiant")
...
public:
	...
	// "/neoradiant" is automatically added if relative paths are used
	 ...
	 * are appended to _topLevelNode (e.g. <neoradiant>) if parentKey is set to the empty string "",
...
private:
	 ...
	 * toplevel node (e.g. "/neoradiant") is appended to the relative ones.
	 */
