...
void XMLRegistry::saveToDisk()
{
    ...
    // Replace the version tag and set it to the current NeoRadiant version
    ...
    // Save the remaining /neoradiant/user tree to user.xml so that the current settings are preserved
