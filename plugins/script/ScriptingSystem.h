...
public:
	 ...
	 * registered interfaces to the Lua context. After this call
	 * the scripting system is ready for use.
	 *
	 * This method also invokes "scripts/init.lua" when done.
	 */
	void				initialise();
	...
	// Runs the named command (or rather the .lua file behind it)
